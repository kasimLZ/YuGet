...
namespace YuGet.Core.Models.Abstraction
{
    ...
    /// </summary>
    public abstract class PackageDetailsCatalogLeaf : CatalogLeaf
    {
        /// <summary>
        ...
        public virtual DateTimeOffset LastEdited { get; set; }

        /// <summary>
        /// The dependencies of the package, grouped by target framework.
        /// </summary>
        [JsonPropertyName("dependencyGroups")]
        public virtual IEnumerable<DependencyGroupItem> DependencyGroups { get; set; }
        ...
        public virtual bool IsPrerelease { get; set; }
        ...
        public virtual string VerbatimVersion { get; set; }

        /// <summary>
        /// The package's License Expression.
        /// </summary>
        [JsonPropertyName("licenseExpression")]
        public virtual string LicenseExpression { get; set; }
