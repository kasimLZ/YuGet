...
namespace YuGet.Core.Internal
{
    ...
    public class RawPackageMetadataClient : IPackageMetadataClient
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            return await _httpClient.GetFromJsonOrDefaultAsync<RegistrationIndexResponseRef>(url, cancellationToken);
        }
        ...
        public async Task<RegistrationPageResponse> GetRegistrationPageAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _httpClient.GetFromJsonAsync<RegistrationPageResponseRef>(pageUrl, cancellationToken);
        }
        ...
        public async Task<RegistrationLeafResponse> GetRegistrationLeafAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            return await _httpClient.GetFromJsonAsync<RegistrationLeafResponseRef>(leafUrl, cancellationToken);
        }
    }
}
