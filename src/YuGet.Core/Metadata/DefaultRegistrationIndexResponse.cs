...
namespace YuGet.Core
{
    ...
    /// </summary>
    /// <remarks>
    /// TODO: After this project is updated to .NET 5, make <see cref="DefaultRegistrationIndexResponse"/>
    ...
    /// </remarks>
    public class DefaultRegistrationIndexResponse
    {
#region Original properties from RegistrationIndexResponse.
        ...
        public IReadOnlyList<DefaultRegistrationIndexPage> Pages { get; set; }
