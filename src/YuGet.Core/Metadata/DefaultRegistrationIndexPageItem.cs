...
namespace YuGet.Core
{
    ...
    /// </summary>
    /// <remarks>
    /// TODO: After this project is updated to .NET 5, make <see cref="DefaultRegistrationIndexPageItem"/>
    ...
    /// </remarks>
    public class DefaultRegistrationIndexPageItem
    {
#region Original properties from RegistrationIndexPageItem.
        ...
        public DefaultPackageMetadata PackageMetadata { get; set; }
    }
}
