...
namespace YuGet.Core
{
    ...
    /// </summary>
    /// <remarks>
    /// TODO: After this project is updated to .NET 5, make <see cref="DefaultRegistrationIndexPage"/>
    ...
    /// </remarks>
    public class DefaultRegistrationIndexPage
    {
#region Original properties from RegistrationIndexPage.
        ...
        public IReadOnlyList<DefaultRegistrationIndexPageItem> ItemsOrNull { get; set; }
    }
}
